...
parser.add_argument("type_of_serialization", choices=['json', 'pickle', 'toml', 'yaml', 'python'], type=str)
parser.add_argument("type_of_source_serialization", choices=['json', 'pickle', 'toml', 'yaml', 'python'], type=str)
